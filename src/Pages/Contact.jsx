...
const Contact = () => {
  ...
  return (
    <Motion>
      <div className="min-h-screen flex flex-col items-center px-4 sm:px-6 py-10 mt-14">
        <h1 className="text-3xl sm:text-4xl font-bold heading-primary mb-6 text-center">
          Contact Us
        </h1>
