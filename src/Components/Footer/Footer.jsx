        ...
        <footer className="footer footer-horizontal footer-center bg-gradient-to-r from-sky-600 to-sky-300 text-base-content rounded p-10 mt-10 font-semibold clip-footer">
          ...
          <Marquee className="bg-sky-300 py-5 text-sky-950 font-bold text-xm rounded-lg">
            <p>
              ...
              can report local problems such as garbage, waterlogging, or road
              damage. Each user can track their submitted issues, update their
              status, and contribute to cleanup efforts. Users can also view
              their payment history and download contribution reports in PDF
              format for record-keeping. The system ensures personalized access,
              showing only the data relevant to the logged-in user.
            </p>
          </Marquee>
          ...
          <aside>
            <p>
              ...
              <span className="font-extrabold">
                C<span className="text-sky-950">C&I</span>RP
              </span>{" "}
              Ltd
            </p>
          </aside>
